...
exports.validateCurrWorkingDirectory = exports.createObject = void 0;
...
function createObject(args) {
    return __awaiter(this, void 0, void 0, function () {
        var dirs, baseFolder, folder, slashPos, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseFolder = 'src/';
                    ...
                    dirs = {
                        targetDirectory: path_1["default"].join(process.cwd(), baseFolder, folder),
                        templateDirectory: path_1["default"].join(__dirname, '../templates', args.type.toLowerCase())
                    };
                    fs_extra_1["default"].ensureDir(path_1["default"].join(process.cwd(), baseFolder)).then(function () {
                        console.log("%s base folder %s found or created.", chalk_1["default"].cyan('ENSURE-DIR'), baseFolder);
                    })["catch"](function (err) {
                        console.error('%s Base Folder %s not in current directory and could not be created. %s', chalk_1["default"].red.bold('ERROR'), baseFolder, err);
                    });
                    fs_extra_1["default"].ensureDir(dirs.targetDirectory).then(function () {
                        console.log("%s target folder of %s.", chalk_1["default"].cyan('ENSURE-DIR'), dirs.targetDirectory);
                    })["catch"](function (err) {
                        console.error('%s Base Folder %s not in current directory and could not be created. %s', chalk_1["default"].red.bold('ERROR'), dirs.targetDirectory, err);
                    });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 5:
                    _a.sent();
                    console.log('%s Object Create Complete.', chalk_1["default"].green.bold('SUCCESS'));
                    return [2 /*return*/];
            }
        });
    });
...
function validateCurrWorkingDirectory() {
    return __awaiter(this, void 0, void 0, function () {
        var cwd, appJsonFilePath, err_2, appJsonBuffer, appJson, idRange;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cwd = process.cwd();
                    appJsonFilePath = path_1["default"].join(cwd, 'app.json');
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, promises_1["default"].access(appJsonFilePath)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    err_2 = _a.sent();
                    console.error('%s No app.json file found in working directory.', chalk_1["default"].red.bold('ERROR'));
                    process.exit(0);
                    return [3 /*break*/, 4];
                case 4:
                    appJsonBuffer = fs_extra_1["default"].readFileSync(appJsonFilePath);
                    appJson = JSON.parse(appJsonBuffer.toString());
                    idRange = {
                        from: appJson['idRanges'][0]['from'],
                        to: appJson['idRanges'][0]['to']
                    };
                    interfaces_1.setIDRange(idRange);
                    return [2 /*return*/];
            }
        });
    });
}
exports.validateCurrWorkingDirectory = validateCurrWorkingDirectory;
